...
class Example(App):
    ...
    def show_example_grid_bottom_sheet(self):
        ...
        bs_menu.add_item(
            ...
            icon_src="demos/Aye/assets/facebook-box.png",
        )
        bs_menu.add_item(
            "YouTube",
            lambda x: self.callback_for_menu_items("YouTube"),
            icon_src="demos/Aye/assets/youtube-play.png",
        )
        bs_menu.add_item(
            "Twitter",
            lambda x: self.callback_for_menu_items("Twitter"),
            icon_src="demos/Aye/assets/twitter.png",
        )
        bs_menu.add_item(
            "Da Cloud",
            lambda x: self.callback_for_menu_items("Da Cloud"),
            icon_src="demos/Aye/assets/cloud-upload.png",
        )
        bs_menu.add_item(
            "Camera",
            lambda x: self.callback_for_menu_items("Camera"),
            icon_src="demos/Aye/assets/camera.png",
        )
        bs_menu.open()
