...
<ExampleMDTextFieldRect@BoxLayout>:
    ...
    canvas:
        Rectangle:
            pos: self.pos
            size: self.size
            source: 'demos/Aye/assets/crop-blur.jpg'

    Image:
        source: 'demos/Aye/assets/twitter-red.png'
        size_hint: None, None
        size: dp(60), dp(60)
        pos_hint: {'center_x': .5}
...
class Example(App):
    ...
    def __init__(self, **kwargs):
        ...
        path_to_crop_image = \
            '{}/demos/Aye/assets/crop-blur.jpg'.format(self.directory)
        path_to_origin_image = \
            '{}/demos/Aye/assets/blur.jpg'.format(self.directory)
