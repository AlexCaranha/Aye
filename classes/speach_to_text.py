    ...
    with m as source:
        ...
        while True:            
            ...
            try:
                ...
                util.text_to_speech(f"Você disse: {value}")

                saida = comandos.identify_request(value)
                if saida != None:
                    util.text_to_speech(saida)

            except sr.UnknownValueError:
                util.text_to_speech("Comando não reconhecido.")
