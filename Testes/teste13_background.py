...
def callback(recognizer, audio):
    ...
    try:
        ...
        print("before")
        output = recognizer.recognize_google(audio, language="pt-BR")
        print("after")
